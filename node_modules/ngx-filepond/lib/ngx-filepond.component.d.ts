...
export declare class FilePondComponent implements AfterViewInit, OnChanges, OnDestroy {
    ...
    onreorderfiles: EventEmitter<any>;
    private root;
    private zone;
    private pond;
    private handleEvent;
