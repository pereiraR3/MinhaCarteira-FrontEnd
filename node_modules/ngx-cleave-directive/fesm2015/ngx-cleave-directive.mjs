...
class NgxCleaveDirective {
    constructor(elementRef, ngControl) {
        ...
        this.rawValue = false;
        this.viewToModelUpdate = (_a = this.ngControl) === null || _a === void 0 ? void 0 : _a.viewToModelUpdate;
        if (!this.ngControl) {
    ...
    ngOnInit() {
        if (this.ngControl) {
            ...
            this.ngControl.viewToModelUpdate = (_) => {
                var _a, _b, _c;
                (_a = this.viewToModelUpdate) === null || _a === void 0 ? void 0 : _a.call(this.ngControl, 
                // update model with the value got from the Cleave instance
                this.rawValue
                    ? (_b = this.cleaveInstance) === null || _b === void 0 ? void 0 : _b.getRawValue()
                    : (_c = this.cleaveInstance) === null || _c === void 0 ? void 0 : _c.getFormattedValue());
            };
        }
    }
    ngOnDestroy() {
    ...
    setCleave() {
        var _a;
        (_a = this.cleaveInstance) === null || _a === void 0 ? void 0 : _a.destroy();
        this.cleaveInstance = new Cleave(this.elementRef.nativeElement, Object.assign(Object.assign({}, this.cleave), { onValueChanged: ({ target }) => {
        ...
        if (!this.rawValue) {
            ...
            setTimeout(() => { var _a; return (_a = this.cleaveInstance) === null || _a === void 0 ? void 0 : _a.setRawValue(this.ngControl.value); }, 0);
        }
    }
}
