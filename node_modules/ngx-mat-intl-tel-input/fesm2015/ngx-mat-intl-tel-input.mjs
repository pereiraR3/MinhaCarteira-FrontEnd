...
import { Injectable, Pipe, EventEmitter, Component, ChangeDetectionStrategy, Optional, Self, Input, ViewChild, HostBinding, Output } from '@angular/core';
...
SearchPipe.ɵpipe = /*@__PURE__*/ i0.ɵɵdefinePipe({ name: "search", type: SearchPipe, pure: true, standalone: true });
(function () {
...
class NgxMatIntlTelInputComponent extends _NgxMatIntlTelInputMixinBase {
    ...
    onPhoneNumberChange() {
        var _a, _b, _c, _d, _e;
        try {
            this.numberInstance = parsePhoneNumberFromString(((_a = this.phoneNumber) === null || _a === void 0 ? void 0 : _a.toString()) || '', (_b = this.selectedCountry) === null || _b === void 0 ? void 0 : _b.iso2.toUpperCase());
            ...
            if (this.numberInstance && this.numberInstance.isValid()) {
                ...
                if (((_d = this.selectedCountry) === null || _d === void 0 ? void 0 : _d.iso2) !== this.numberInstance.country &&
    ...
    formatAsYouTypeIfEnabled() {
        ...
        const asYouType = new AsYouType((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.iso2.toUpperCase());
...
NgxMatIntlTelInputComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxMatIntlTelInputComponent, selectors: [["ngx-mat-intl-tel-input"]], viewQuery: function NgxMatIntlTelInputComponent_Query(rf, ctx) {
        if (rf & 1) {
