...
import { MatCommonModule } from '@angular/material/core';import { SpkApexchartsComponent } from '../../../../../@spk/spk-apexcharts/apexcharts.component';
...
export class RadialbarChartsComponent {
  ...
  constructor() {
    ...
    this.chartOptions1= {
      ...
      colors: ["#845adf", "#e354d4", "#ff8e6f", "#e6533c"],
