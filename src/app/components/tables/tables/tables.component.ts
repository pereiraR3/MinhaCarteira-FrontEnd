...
@Component({
  selector: 'app-tables',
  standalone: true,
  imports: [SharedModule, ShowcodeCardComponent,SpkReusableTablesComponent,FormsModule],
...
export class TablesComponent {
 ...
 borderTables=[
 {src:"./assets/images/faces/13.jpg",bg:"bg-success/10 text-success",status:"Active",name:"Sukuro Kim",mail:"kimosukuro@gmail.com"},
 {src:"./assets/images/faces/6.jpg",bg:"badge bg-light text-dark",status:"Inactive",name:"Hasimna",mail:"hasimna2132@gmail.com"},
 {src:"./assets/images/faces/15.jpg",bg:"bg-success/10 text-success",status:"Active",name:"Azimo Khan",mail:"azimokhan421@gmail.com"},
 {src:"./assets/images/faces/5.jpg",bg:"bg-success/10 text-success",status:"Active",name:"Samantha Julia",mail:"julianasams143@gmail.com"},
]
borderprimaryColumn=[
...
stripedrowColumn=[
 ...
 hoverRowTables=[
  {src:"./assets/images/faces/10.jpg",name:"Joanna Smith",mail:"joannasmith14@gmail.com",status:"Fashion",bg:"primary/10", bg1:"primary",
   images:["./assets/images/faces/2.jpg","./assets/images/faces/8.jpg","./assets/images/faces/2.jpg"],count:5,progress:"52"},
  {src:"./assets/images/faces/2.jpg",name:"Kara Kova",mail:"milesakara@gmail.com",status:"Clothing",bg:"warning/10", bg1:"warning",
  images:["./assets/images/faces/4.jpg","./assets/images/faces/6.jpg"],count:6,progress:"40"},
  {src:"./assets/images/faces/16.jpg",name:"Donald Trimb",mail:"donaldo21@gmail.com",status:"Electronics",bg:"dark/10", bg1:"dark",
  images:[ "./assets/images/faces/1.jpg", "./assets/images/faces/11.jpg","./assets/images/faces/15.jpg"],count:6,progress:"40"},
  {src:"./assets/images/faces/13.jpg",name:"Justin Gaethje",mail:"justingae@gmail.com",status:"sports",bg:"danger/10", bg1:"danger",
 ...
 hoverstripedRowTables=[
  {id:"IN-2032",src:"./assets/images/faces/15.jpg",customer:"Mark Cruise",mail:"markcruise24@gmail.com",status:"Paid",bg:"success/10", bg1:"text-success",icon:"check-fill", date:"Jul 26,2022"},
  {id:"IN-2022",src:"./assets/images/faces/12.jpg",customer:"Charanjeep",mail:"charanjeep@gmail.in",status:"Paid",bg:"success/10",bg1:"text-success",icon:"check-fill",date:"Mar 14,2022"},
  {id:"IN-2014",src:"./assets/images/faces/5.jpg",customer:"Samantha Julie",mail:"julie453@gmail.com",status:"Cancelled",bg:"danger/10",bg1:"text-danger",icon:"close-fill", date:"Feb 1,2022"},
  {id:"IN-2036",src:"./assets/images/faces/11.jpg",customer:"Simon Cohen",mail:"simon@gmail.com",status:"Refunded",bg:"light text-dark",bg1:"dark:text-white",icon:"reply-line", date:"Apr 24,2022"},
 ]
 headerColumn=[
  {header:"User Name",field:"user"},         
  {header:"Transaction Id",field:"transaction"},
...
activeTables=[
  {name:"Mark",trClass1:"table-active",date:"21,Dec 2021",contact:"+1234-12340",bg:"primary",status:"Completed"},
  {name:"Monika",date:"29,April 2023",contact:"+1523-12459",bg:"warning",status:"Failed"},
...
smallTables=[
  {name:"Zelensky",date:"25-Apr-2021",bg:" bg-success/10 !text-success",status:"Paid",checked:true},
  {name:"Kim Jong",date:"29,April 2022",bg:" bg-danger/10 !text-danger",status:"Pending",checked:false},
  {name:"Obana",date:"30,Nov 2022",bg:" bg-success/10 !text-success",status:"Paid"},
  {name:"Sean Paul",date:"01-Jan-2022",bg:" bg-success/10 !text-success",status:"Paid"},
  {name:"Karizma",date:"14-Feb-2022",bg:" bg-danger/10 !text-danger",status:"Pending"},

]
variantColumn=[
  {header:"Color",field:"Invoice"},         
...
variantTables=[
  {color:"Default",trClass:"",client:"Rita Book",bg:"bg-primary/10 text-primary",status:"Processed",quantity:"22",price:"$2,012"},
  {color:"Primary",client:"Rhoda Report",trClass:"primary",bg:"bg-primary text-white",status:"Processed",quantity:"22",price:"$4,254"},
  {color:"Secondary",client:"Rita Book",trClass:"secondary",bg:"bg-secondary text-white",status:"Processed",quantity:"26",price:"$1,234"},
  {color:"Success",client:"Anne Teak",trClass:"success",bg:"bg-success text-white",status:"Processed",quantity:"42",price:"$2,623"},
  {color:"Danger",client:"Dee End",trClass:"danger",bg:"bg-danger text-white",status:"Processed",quantity:"52",price:"$32,132"},
  {color:"Warning",client:"Lee Nonmi",trClass:"warning",bg:"bg-warning text-white",status:"Processed",quantity:"10",price:"$1,434"},
  {color:"Info",client:"Lynne Gwistic",trClass:"info",bg:"bg-info text-white",status:"Processed",quantity:"63",price:"$1,854"},
  {color:"Light",client:"Fran Tick",trClass:"light",bg:"bg-light text-dark",status:"Processed",quantity:"05",price:"$823"},
  {color:"Dark",client:"Polly Pipe",trClass:"dark",bg:"bg-black text-white",status:"Processed",quantity:"35",price:"$1,832"},
]
nestingColumn=[
  {header:"#",field:"#"},         
  {header:"First",field:"first"},
