...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    /*
    {
      ...
      dirchange: false,
      children: [
        { path: '/administracao/usuario', title: 'Usuarios', type: 'link', dirchange: false },
        { path: '/administracao/pais', title: 'Pais', type: 'link', dirchange: false },
        { path: '/administracao/regiao', title: 'Região', type: 'link', dirchange: false },
        { path: '/administracao/unidadefederativa', title: 'Unidade Federativa', type: 'link', dirchange: false },
        { path: '/administracao/municipio', title: 'Municipio', type: 'link', dirchange: false },
        { path: '/administracao/repositorio', title: 'Repositorio', type: 'link', dirchange: false },
      ],
    },
    */
   
    {
      ...
      dirchange: false,
      children: [
       // { path: '/ks-portal/parceiro', title: 'Parceiros', type: 'link', dirchange: false },
       // { path: '/ks-portal/produto', title: 'Produtos', type: 'link', dirchange: false },
        { path: '/ks-portal/oportunidades', title: 'Oportunidade', type: 'link', dirchange: false },
      //  {path: '/ks-portal/oportunidades-assumidas', title: 'Oportunidades Assumidas', type: 'link', dirchange: false },
